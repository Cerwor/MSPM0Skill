...
| Use Tianqiaoxing MSPM0G3519 GPIO, ADC, PWM, Timer, UART, SPI, or I2C | [tianqiaoxing.md](references/hardware/tianqiaoxing.md) | One matching common-peripheral file | Minimal board adaptation without bundled board-application assumptions |
