...
天堑星 MSPM0G3519 上 SSD1312 OLED 的绘图与菜单框架集成。
...
**Packaged snapshots**: `assets/templates/tianqiaoxing/oled_draw/` and `assets/templates/tianqiaoxing/oled_menu/`
...
```
python -B scripts/scaffold_project.py <project_name> --board tianqiaoxing --template oled_draw --output <output-dir> --probe jlink --dry-run
```
